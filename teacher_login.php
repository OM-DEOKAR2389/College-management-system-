...
<form action="do_teacher_login.php" method="post">
    ...
    <!-- Submit button -->
     <div class="text-center">
       <button  type="submit"  class="btn btn-primary btn-block btn-lg gradient-custom-4" style=" height: 40px; width: 150px; ">Sign in</></button>
    </div>
