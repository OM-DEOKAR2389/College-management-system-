             ...
             <table>
               ...
               include("connection.php");
                ...
                while($row=mysqli_fetch_assoc($result)){
                    echo"<tr><td>".$count."</td><td>".$row["subjects"]."</td><td>".$row["course"]."</td><td>".$row["class"]."</td><td> <a href='remove_subject.php?id=".$row["id"]."' ><button class= 'btn btn-danger'>Remove</button></a></td></tr>";
                    $count++;
